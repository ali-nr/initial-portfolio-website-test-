...
<?php # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - ?>
						...
						<a class="item-edit" id="edit-<?php echo $item_id; ?>" title="<?php esc_attr_e('Edit Menu Item', 'fw'); ?>" href="<?php
...
<?php # Column ?>
				...
				<p class="description description-wide show-if-mega-menu-column">
					<label>
						<input type="checkbox" name="<?php echo fw_mega_menu_name_meta($item, 'new-row') ?>" <?php checked(fw_mega_menu_get_meta($item, 'new-row')) ?> class="mega-menu-column-new-row" />
...
<?php # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - ?>
				<p class="field-description description description-wide hide-if-mega-menu-column force-show-if-mega-menu-item">
					<label for="edit-menu-item-description-<?php echo $item_id; ?>">
						<?php _e( 'Menu Subtitle', 'fw' ); ?><br />
						<input  type="text" id="edit-menu-item-description-<?php echo $item_id; ?>" class="widefat edit-menu-item-description" name="menu-item-description[<?php echo $item_id; ?>]" value="<?php echo esc_attr( $item->description ); ?>"/>
						<span class="description"><?php _e('This for Starry main menus left and right.', 'fw'); ?></span>
					</label>
				</p>
<?php # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - ?>
<?php # Icon ?>
				<p class="field-mega-menu-icon description description-wide empty show-if-screen-options-icon">
					<label>
						...
						<input type="hidden" name="<?php echo fw_mega_menu_name_meta($item, 'icon') ?>" value="<?php echo esc_attr(fw_mega_menu_get_meta($item, 'icon')) ?>" data-subject="mega-menu-icon-input" />
					</label>
				</p>
