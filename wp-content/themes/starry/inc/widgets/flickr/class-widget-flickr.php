...
class Widget_Flickr extends WP_Widget {
	...
	function __construct() {
		...
		parent::WP_Widget( false, __( 'Flickr', 'starry' ), $widget_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'flickr_id' ); ?>"><?php _e( 'Flickr ID', 'starry' ); ?> (<a
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e( 'Number of photos', 'starry' ); ?>
				:</label>
